...
describe('All Tests', function() {
	...
	describe('Interceptor Registry Tests', function() {
		...
		it('Create Interceptor Instance', function() {
			let inst: Processor = interceptor.interceptorRegistry.createInterceptor(FooInterceptor.name);	
			expect(inst instanceof FooInterceptor).to.equal(true);
		});
	});

	describe('Component Wrapper Tests', function() {
		@Interceptor({
			"interactionStyle": InteractionStyleType.SYNC
		})
	...
	describe('Invocation Runtime Tests', function() {
